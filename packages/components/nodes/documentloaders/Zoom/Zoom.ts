...
class ZoomTranscripts_DocumentLoaders implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    constructor() {
        ...
        this.description = `Bring in your Zoom transcripts to analyze and summarize.`
...
module.exports = {
    nodeClass: ZoomTranscripts_DocumentLoaders
}
